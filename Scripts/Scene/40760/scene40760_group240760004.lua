...
gadgets = {
	...
	{ config_id = 4001, gadget_id = 70340014, pos = { x = -0.004, y = 9.803, z = -46.891 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },

	-- Decorative reward effect/object.
	{ config_id = 4002, gadget_id = 70350008, pos = { x = -0.004, y = 14.623, z = -42.271 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
