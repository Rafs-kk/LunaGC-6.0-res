...
gadgets = {
	-- Actual reward tree/statue interaction gadget.
	{ config_id = 4001, gadget_id = 70340014, pos = { x = -0.001, y = 9.073, z = -47.939 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1 },
	-- Decorative reward effect.
	{ config_id = 4002, gadget_id = 70350008, pos = { x = -0.001, y = 13.420, z = -42.300 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}
