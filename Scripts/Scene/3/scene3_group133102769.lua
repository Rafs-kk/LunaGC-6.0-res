...
function action_EVENT_GADGET_CREATE_769030(context, evt)
	...
	-- The 6.0 client/server combo is not reliably showing/using the worktop option, so Oceanid is started directly from ENTER_REGION_769057 instead.
	return 0
end
...
function action_EVENT_LEAVE_REGION_769060(context, evt)
	...
	-- LunaGC 6.0 does not reliably expose this ScriptLib method, and it is only a camera/vision cleanup path. Letting it crash breaks Oceanid's boss state.
